...
// TODO: document somewhere that the choice of Cow everywhere is no coincidence:
// ComponentDescriptor will inevitably grow, and I don't want to refactor everything when that
// ineluctably happen.
